    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-sm mx-auto px-4">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Sign in to list items</h2>
          <p className="text-gray-500 mb-6 text-sm">Verify your USC identity to create and manage listings.</p>
          <Link to="/auth">
